...
public class FlywheelConstants {
  ...
  // We add the config later after building. For now this is the old elevator stuff
  static {
    ...
    baseMotorConfig.MotionMagic =
        new MotionMagicConfigs().withMotionMagicCruiseVelocity(15).withMotionMagicAcceleration(30);
  }
