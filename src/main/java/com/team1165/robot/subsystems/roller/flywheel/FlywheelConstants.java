...
public class FlywheelConstants {
    ...
    public static final TalonFXConfiguration baseMotorConfig =
    ...
    static {
        ...
        baseMotorConfig.MotorOutput.Inverted =
        ...
        baseMotorConfig.Slot0 = new Slot0Configs()
            .withKP(0.1)
            .withKI(0.0)
            .withKD(0.0)
            .withKS(0.0)
    ...
    public static final TalonFXConfig primaryMotorConfig = new TalonFXConfig(
        "FlywheelPrimary",
        CANivore.flywheelPrimary,
        CANivore.bus,
        baseMotorConfig
    );
    public static final TalonFXConfig secondaryMotorConfig = new TalonFXConfig(
        "FlywheelSecondary",
        CANivore.flywheelSecondary,
        CANivore.bus,
        baseMotorConfig
    );
}
