  ...
  public RobotContainer() {
    switch (RobotMode.get()) {
      case REAL -> {
        ...
        //                drive::getRotation,
        //                new CameraConfig(new ATVisionIOPhoton(RightCamera.name),
        // RightCamera.robotToCamera),
        //                new CameraConfig(new ATVisionIOPhoton(LeftCamera.name),
        // LeftCamera.robotToCamera));
